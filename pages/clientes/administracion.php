                    ...
                    <div class="card-body">
                        <nav class="nav flex-column nav-pills nav-gap-y-1">
                            ...
                            <a href="#notification" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded">
                                <i class="bi bi-bell-fill" style="font-size: 1.5rem; color: #000a;padding-right:5px;"></i>
                                Notificaciones
                            </a>
                ...
                <div class="card">
                    <div class="card-header border-bottom mb-3 d-flex d-md-none">
                        <ul class="nav nav-tabs card-header-tabs nav-gap-x-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a href="#notification" data-toggle="tab" class="nav-link has-icon"><i class="bi bi-bell-fill" style="font-size: 1.5rem; color: #000a;padding-right:5px;"></i></a>
                            </li>
                            <li class="nav-item">
                                ...
                                <form action="../../drivers/clientes/actualizarnotif.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="form-check-input" id="customCheck1" name="s1" <?php if ($consulta['inicio_sesion'] == 1) {
                                                                                                                            echo "checked";
                                                                                                                        } ?>>
                                            <label class="custom-control-label" for="customCheck1">Cada vez que se inicie sesión</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="form-check-input" id="customCheck2" name="s2" <?php if ($consulta['error_3'] == 1) {
                                                                                                                            echo "checked";
                                                                                                                        } ?>>
                                        ...
                                        <ul class="list-group list-group-sm">
                                            <li class="list-group-item has-icon">
                                                ...
                                                <div class="form-check form-switch ml-auto">
                                                    <input type="checkbox" class="form-check-input" id="customSwitch1" name="v1" <?php if ($consulta['confirmacion_viaje'] == 1) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                            ...
                                            <li class="list-group-item has-icon">
                                                ...
                                                <div class="form-check form-switch ml-auto">
                                                    <input type="checkbox" class="form-check-input" id="customSwitch2" name="v2" <?php if ($consulta['confirmacion_pago'] == 1) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <ul class="list-group list-group-sm">
                                            <li class="list-group-item has-icon">
                                                ...
                                                <div class="form-check form-switch ml-auto">
                                                    <input type="checkbox" class="form-check-input" id="customSwitch1" name="p1" <?php if ($consulta['tendencia'] == 1) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                                    <label class="custom-control-label" for="customSwitch1"></label>
                                                </div>
                                            ...
                                            <li class="list-group-item has-icon">
                                                ...
                                                <div class="form-check form-switch ml-auto">
                                                    <input type="checkbox" class="form-check-input" id="customSwitch2" name="p2" <?php if ($consulta['oferta'] == 1) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                                    <label class="custom-control-label" for="customSwitch2"></label>
                                                </div>
                                            ...
                                            <li class="list-group-item has-icon">
                                                Novedades
                                                <div class="form-check form-switch ml-auto">
                                                    <input type="checkbox" class="form-check-input" id="customSwitch3" name="p3" <?php if ($consulta['novedades'] == 1) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                            ...
                                            <li class="list-group-item has-icon">
                                                Eventos
                                                <div class="form-check form-switch ml-auto">
                                                    <input type="checkbox" class="form-check-input" id="customSwitch4" name="p4" <?php if ($consulta['eventos'] == 1) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <ul class="list-group list-group-sm">
                                            <li class="list-group-item has-icon">
                                                ...
                                                <div class="form-check form-switch ml-auto">
                                                    <input type="checkbox" class="form-check-input" id="customSwitch1" name="pl1" <?php if ($consulta['actualizacion'] == 1) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                                    <label class="custom-control-label" for="customSwitch1"></label>
                                                </div>
                                            ...
                                            <li class="list-group-item has-icon">
                                                ...
                                                <div class="form-check form-switch ml-auto">
                                                    <input type="checkbox" class="form-check-input" id="customSwitch2" name="pl2" <?php if ($consulta['noticias'] == 1) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                                    <label class="custom-control-label" for="customSwitch2"></label>
                                                </div>
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-around">
                                        ...
                                        <div class="plin">
                                            <img src="../../img/plin.png" alt="plin" style="width:100px;height:100px;">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mb-0">
